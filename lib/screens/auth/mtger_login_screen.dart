...
class MtgerLoginScreen extends StatefulWidget {
  MtgerLoginScreen({Key key}) : super(key: key);

  @override
  _MtgerLoginScreenState createState() => _MtgerLoginScreenState();
}

class _MtgerLoginScreenState extends State<MtgerLoginScreen> {
  double _height;
  double _width;
          ...
          children: <Widget>[
            ...
            Center(
              child: Container(
                ...
                child: Text("بالتحقق من رقم عضويتك تصبح قادر على إدارة ",
                  maxLines: 1,
            ...
            Container(
              ...
              iconIsImage: true,
              imagePath: 'assets/images/pincle.png',
              hintTxt: "رقم العضوية",
                   ...
                   if (_formKey.currentState.validate()) {
                     _firebaseMessaging.getToken().then((token) async {
                       ...
                       var results = await _services.get(
                         '${Utils.MTGER_SENDCODE_URL}?mtger_id=$_userPhone&token=$token&lang=${_appState.currentLang}&key=$cKey',
                       );
                       ...
                       if (results['response'] == '1') {
                         ...
                         Navigator.pushNamed(context, '/mtger_register_code_activation_screen' );
                       } else {
