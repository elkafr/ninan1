...
class AddCatScreen extends StatefulWidget {
  AddCatScreen({Key key}) : super(key: key);

  @override
  _AddCatScreenState createState() => _AddCatScreenState();
}

class _AddCatScreenState extends State<AddCatScreen>  with ValidationMixin{
                ...
                onPressedFunction: () async {
                  ...
                  checkAddCatValidation(context,
                    ...
                    final results = await _services
                        .postWithDio("https://ninanapp.com/app/api/mtger_add_mtger_cat1", body: formData);
