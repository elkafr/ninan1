...
class AddConvertScreen extends StatefulWidget {
  AddConvertScreen({Key key}) : super(key: key);

  @override
  _AddConvertScreenState createState() => _AddConvertScreenState();
}

class _AddConvertScreenState extends State<AddConvertScreen>  with ValidationMixin{
      ...
      child: Form(
        ...
        child: Column(
          children: <Widget>[
            ...
            Image.asset("assets/images/convert1.png"),
            SizedBox(
              height: _height * 0.04,
            ),
            Container(
                    ...
                    child: Container(
                      ...
                      child: ListTile(
                        ...
                        title: Column(
                          ...
                          mainAxisAlignment: MainAxisAlignment.start,
                          children: <Widget>[
                            Text("ارفق صورة التحويل",style: TextStyle(color: cText,fontSize: 15),),
                            Padding(padding: EdgeInsets.all(5)),
                            Text(" فضلا قم بارفق صورة التحويل المرسل على البنك المختار",style: TextStyle(color: Color(0xffABABAB),fontSize: 11),),
                          ],
                        ),
                      ),
                    )),
                ...
                onPressedFunction: () async {
                  ...
                  checkAddRequestValidation(context,
                    ...
                    FormData formData = new FormData.fromMap({
                      ...
                      "request_mtger":_storeState.currentStore.mtgerId,
                    ...
                    final results = await _services
                        .postWithDio("https://ninanapp.com/app/api/mtger_add_convert", body: formData);
