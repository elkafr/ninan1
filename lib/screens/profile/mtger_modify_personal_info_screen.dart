...
class MtgerModifyPersonalInformationScreen extends StatefulWidget {
  MtgerModifyPersonalInformationScreen({Key key}) : super(key: key);

  @override
  _MtgerModifyPersonalInformationScreenState createState() => _MtgerModifyPersonalInformationScreenState();
}

class _MtgerModifyPersonalInformationScreenState extends State<MtgerModifyPersonalInformationScreen>  with ValidationMixin{
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: CustomTextFormField(
                hintTxt:"الخانة المطلوب تعديلها	",
                validationFunc: (value) {
                  if (value.trim().length == 0) {
                    return "برجاء ادخال اسم الخانة";
                  }
                  return null;
                },
            ...
            Container(
              ...
              child: CustomTextFormField(
                ...
                hintTxt:"المحتوى المطلوب	",
                validationFunc: (value) {
                  if (value.trim().length == 0) {
                    return "برجاء ادخال المحتوى المطلوب	";
                  }
                  return null;
                },
                inputData: TextInputType.text,
                    ...
                    child: Container(
                      ...
                      child: ListTile(
                        ...
                        title: Column(
                          ...
                          children: <Widget>[
                            Text("الصورة ان وجدت",style: TextStyle(color: cText,fontSize: 15),),
                            Padding(padding: EdgeInsets.all(5)),
                            Text(" لو المحتوى المطلوب تغييره عبارة عن صورة ارفقها هنا",style: TextStyle(color: Color(0xffABABAB),fontSize: 11),),
                          ],
                        ),
                      ),
                    )),
                ...
                onPressedFunction: () async {
                  ...
                  checkAddCatValidation(context,
                    ...
                    FormData formData = new FormData.fromMap({
                      ...
                      "editt_user":_storeState.currentStore.mtgerId,
                      "editt_type":"mtger",
