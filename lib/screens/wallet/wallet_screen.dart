...
import 'package:ninan1/screens/wallet/add_convert.dart';
...
class _WalletScreenState extends State<WalletScreen> {
  ...
  Future<List<Request>> _getRequests() async {
    Map<String, dynamic> results = await _services.get(
        'https://ninanapp.com/app/api/driver_portfolio?lang=${_appState.currentLang}&page=1&user_id=${_appState.currentUser.userId}');
