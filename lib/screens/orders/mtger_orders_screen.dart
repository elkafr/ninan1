...
class MtgerOrdersScreen extends StatefulWidget {
  @override
  _MtgerOrdersScreenState createState() => _MtgerOrdersScreenState();
}

class _MtgerOrdersScreenState extends State<MtgerOrdersScreen> {
    ...
    return  NetworkIndicator( child:PageContainer(
        child: DefaultTabController(
          initialIndex: tabState.initialIndex,
            ...
            child: Scaffold(
                key: _scaffoldKey, //
                drawer: MtgerMainDrawer(),
          body: Stack(

            children: <Widget>[
              _buildBodyItem(),
              storeState.currentStore != null?Positioned(
               top: 50,
               child:   Container(
                      ...
                      if(tabState.initialIndex==0){
                        showModalBottomSheet<dynamic>(
                            ...
                            builder: (builder) {
                              return Container(
                                height: _height*.50,
                                child: MtgerFilterProcessingOrders(),
                              );
                            });
                      }else{
                        showModalBottomSheet<dynamic>(
