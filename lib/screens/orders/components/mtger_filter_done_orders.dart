...
class MtgerFilterDoneOrders extends StatefulWidget {
  const MtgerFilterDoneOrders({Key key}) : super(key: key);
  @override
  _MtgerFilterDoneOrdersState createState() => _MtgerFilterDoneOrdersState();
}

class _MtgerFilterDoneOrdersState extends State<MtgerFilterDoneOrders> {
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text("فرز الطلبات السابقة",style: TextStyle(color: cText,fontSize: 16,fontWeight: FontWeight.bold),),
                    Padding(padding: EdgeInsets.all(5)),
                    Text("فرز الطلبات السابقة حسب الحالة",style: TextStyle(color: cHintColor,fontSize: 13),),
                  ],
                ),
              ),
