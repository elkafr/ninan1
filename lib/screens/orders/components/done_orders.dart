...
class _DoneOrdersState extends State<DoneOrders> {
  ...
  Future<List<Order>> _getOrderList() async {
    ...
    Map<String, dynamic> results = _appState.filterOrders==null || _appState.filterOrders==11?await _services.get(
        'https://ninanapp.com/app/api/driver_dis_buy?lang=${_appState.currentLang}&user_id=${_appState.currentUser.userId}&driverMapx=${_locationState.locationLatitude.toString()}&driverMapy=${_locationState.locationlongitude.toString()}&page=1&done=0'):await _services.get(
