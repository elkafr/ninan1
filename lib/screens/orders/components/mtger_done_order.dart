...
class MtgerDoneOrder extends StatefulWidget {
  final bool isCancelOrder;
  final Order order;

  const MtgerDoneOrder({Key key, this.isCancelOrder = false, this.order})
      : super(key: key);
  @override
  _MtgerDoneOrderState createState() => _MtgerDoneOrderState();
}

class _MtgerDoneOrderState extends State<MtgerDoneOrder> {
  @override
