              ...
              child: _appState.currentUser == null
                  ...
                  : Consumer<StoreState>(builder: (context, storeState, child) {
                      ...
                      if (storeState
                              ...
                              await _services.get(
                                  'https://ninanapp.com/app/api/delete_save_ads?user_id=${_appState.currentUser.userId}&mtger_id=${widget.store.mtgerId}');
                            } else {
                              print('you should add');
                              await _services.get(
                                  'https://ninanapp.com/app/api/add_fav?user_id=${_appState.currentUser.userId}&mtger_id=${widget.store.mtgerId}');
                            }
